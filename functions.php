...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'wp-bootstrap-starter-roboto-font', 'https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i,900,900i' );
    wp_enqueue_style( 'wp-bootstrap-starter-poppins-font', 'https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700' );
    wp_enqueue_style( 'wp-bootstrap-starter-lato-font', 'https://fonts.googleapis.com/css2?family=Lato:wght@900' );
    ...
    /* custom css */
        wp_enqueue_style('custom_style', get_template_directory_uri() . '/inc/assets/css/custom.css', array(), '1.0', 'all'  );
        wp_enqueue_script('custom_js', get_template_directory_uri() . '/inc/assets/js/custom.js', array(), '1.0', 'bool $in_footer');
}
...
add_action('custimze_register','header_slider_bs');